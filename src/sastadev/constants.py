...
errors_overview_suffix = '_errors_overview'
...
false_start_mode = 'false start mode'
figures_by_ds_gramm_err_filename = 'figures_by_ds_gramm_err.xlsx'
f1byuttidsheetname = 'F1byUttId'
figuresfolder = '_Figures'
formsfolder = 'forms'
grammaticale_fout = 'grammaticale fout'
indatafolder = 'indata'
...
SASTA_opmerkingen = 'SASTA-opmerkingen'
...
self_correction_mode = 'self-correction mode'
