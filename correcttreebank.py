...
from lexicon import de, dets, known_word, getwordinfo
from metadata import (Meta, bpl_delete, bpl_indeze, bpl_node, bpl_none,
                      bpl_word, bpl_wordlemma, bpl_cond, bpl_replacement)
...
from treebankfunctions import (adaptsentence, add_metadata, countav,
                               ...
                               updatetokenpos, getuttid, find1, getptsubclass ,subclasscompatible)
...
from syllablecount import countsyllables
